...
squarish: Do the same thing except that the 4 points at each corner of the square have also been selected.

MakeParallel: Select two lines in a line feature that are roughly parallel and make them fully parallel
